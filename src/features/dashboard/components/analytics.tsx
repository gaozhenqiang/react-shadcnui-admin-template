      ...
      <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>较上周 +12.4%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>较上周 +5.8%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>较上周 -3.2%</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-sm font-medium'>平均会话</CardTitle>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 24 24'
              fill='none'
          ...
          <CardContent>
            ...
            <p className='text-muted-foreground text-xs'>较上周 +18s</p>
          </CardContent>
        </Card>
      </div>
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-7'>
        ...
        <Card className='col-span-1 lg:col-span-3'>
          <CardHeader>
            ...
            <CardDescription>用户访问设备分布</CardDescription>
          </CardHeader>
          <CardContent>
            <SimpleBarList
              items={[
